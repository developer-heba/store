                        ...
                        <div class="col-md-12">
                            ...
                            @isset($images)
                                @foreach($images as $image )
                                    <tr>
                                        <td>{{$image->id}}</td>
                                         <td>   <a href="{{asset('assets/images/sliders/'.$image -> photo)}}" itemprop="contentUrl"
                                            data-size="480x360">
                                             <img class="img-thumbnail img-fluid" width="100"
                                             height='100'
                                         
                                                  src="{{asset('assets/images/sliders/'.$image -> photo)}}"
                                        ...
                                        <td>
                                            <div class="btn-group" role="group"
                                                ...
                                                <a href="{{asset('admin/sliders/images/delete/'.$image->id)}}"
