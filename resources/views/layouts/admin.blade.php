...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/vendors/css/editors/tinymce/tinymce.min.css')}}">
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
...
<script src="{{asset('assets/admin/vendors/js/editors/tinymce/tinymce.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/admin/js/scripts/editors/editor-tinymce.js')}}" type="text/javascript"></script>
